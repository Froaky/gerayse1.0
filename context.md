...
- Pendiente 2: barrer la base productiva buscando duplicados YA cargados (el par de la foto puede no ser el unico). Query sugerida en el cierre de la tarea; no se corrio porque requiere acceso a la base de Railway.
